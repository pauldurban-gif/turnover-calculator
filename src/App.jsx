...
const STEPS = [
  ...
  { id: "departures", question: "How many departures per year do you want to calculate for?", sub: "The middle option reflects the nonprofit sector average for your staff size. You can run the calculator again to compare scenarios." },
];
const OPTIONS_MAP = {
                  ...
                  {(() => {
                    ...
                    return (
                      <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: "10px" }}>
                        {options.map(opt => {
                          const selected = answers.departures === opt.id;
                          return (
                            <DepartureButton
                              key={opt.id}
                              opt={opt}
